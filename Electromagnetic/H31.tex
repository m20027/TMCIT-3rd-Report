...
\begin{align*}
    \int_{C}\boldsymbol{H}_{1}\cdot d\boldsymbol{l}&=\int_{C}Hdl=2\pi (R-c)H_{1}\,[\rm{A}]\\
    \int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\int_{S}JdS=\pi a^{2}J\,[\rm{A}]\\
    H_{1}&=\frac{a^{2}}{2(R-c)}J\,[\rm{A/m}]\\
    \int_{C}\boldsymbol{H}_{2}\cdot d\boldsymbol{l}&=\int_{C}Hdl=2\pi RH_{2}\,[\rm{A}]\\
    \int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\int_{S}JdS=\pi b^{2}J\,[\rm{A}]\\
    H_{2}&=\frac{b^{2}}{2R}J\,[\rm{A/m}]\\
    \text{Because of the point A's Magnetic field that }&\text{this conductor make can disassemble }H_{1}, H_{2}\\
    H&=H_{2}-H_{1}\\
    &=\frac{1}{2}\left(\frac{b^{2}}{R}-\frac{a^{2}}{(R-c)}\right)J\,[\rm{A/m}]\quad (a<b)
\end{align*}
\end{document}