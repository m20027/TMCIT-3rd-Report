...
\begin{enumerate}[(a)]
	...
	r>aのとき&\\
	\int_{C}\boldsymbol{H}\cdot d\boldsymbol{l}&=\int_{C}Hdl=2\pi rH\,[\rm{A}]\\
	\int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\frac{\pi a^{2} J_{1}}{2}-\pi J_{1}\left(a^{2}-\frac{a^{2}}{2}\right)=0\,[\rm{A}]\\
	...
	コイルの内部&\\
	\int_{C}\boldsymbol{H}\cdot d\boldsymbol{l}&=\int_{C}Hdl=2\pi rH\,[\rm{A}]\\
	\int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\int_{S}JdS=\int_{0}^{2\pi}\int_{0}^{r}\frac{J_{2}}{r}drd\theta=2\pi r J_{2}\,[\rm{A}]\\
	H&=J_{2}\,[\rm{A/m}]\\
	コイルの外部&\\
	\int_{C}\boldsymbol{H}\cdot d\boldsymbol{l}&=\int_{C}Hdl=2\pi rH\,[\rm{A}]\\
	\int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\int_{S}JdS=\int_{0}^{2\pi}\int_{0}^{a}\frac{J_{2}}{r}drd\theta=2\pi a J_{2}\,[\rm{A}]\\
