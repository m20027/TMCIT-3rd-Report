...
\begin{align*}
	\int_{S}\boldsymbol{J}\cdot d\boldsymbol{S}&=\int_{C}\boldsymbol{H}\cdot d\boldsymbol{l}\\
	\int_{S}JdS&=\int_{C}Hdl\\
	J(r)\cdot \pi a^{2}&=H\cdot 2\pi r\\
	J(r)&=\frac{2r}{a^{2}}H\\
	\frac{d}{dr}J(r)&=\frac{2}{a^{2}}H\\
\end{align*}
\end{document}