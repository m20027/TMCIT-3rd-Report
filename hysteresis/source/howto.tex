...
\item ヒステリシス曲線の測定
\begin{enumerate}[i)]
	\item \wfig{circ}の$\rm{S_{1}}$に\wfig{ad}の$\rm{S_{1}}$を\wfig{circ}の$\rm{S_{2}}$に\wfig{ad}の$\rm{S_{2}}$を接続．
	\begin{figure}[h]
	\centering
	...
	\item ch1プローブのGNDを\wfig{circ}の$\rm{P_{2}}$へ，プローブの先をA点に接続し，ch2のプローブのGNDを\wfig{ad}のB点へ，プローブの先を$\rm{S_{2}}$に接続．
